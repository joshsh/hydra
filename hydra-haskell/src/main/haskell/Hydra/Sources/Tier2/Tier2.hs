...
getTermTypeDef :: Definition (Term -> Flow (Graph Kv) (Maybe (Type)))
...
requireElementTypeDef :: Definition (Element Kv -> Flow (Graph Kv) (Type))
...
requireTermTypeDef :: Definition (Term -> Flow (Graph Kv) (Type))
