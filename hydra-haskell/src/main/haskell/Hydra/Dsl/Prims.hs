...
prim0Poly :: [String] -> Name -> TermCoder x -> x -> Primitive
...
prim1Poly :: [String] -> Name -> TermCoder x -> TermCoder y -> (x -> y) -> Primitive
...
prim2Poly :: [String] -> Name -> TermCoder x -> TermCoder y -> TermCoder z -> (x -> y -> z) -> Primitive
...
prim3Poly :: [String] -> Name -> TermCoder w -> TermCoder x -> TermCoder y -> TermCoder z -> (w -> x -> y -> z) -> Primitive
