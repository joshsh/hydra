...
jsonByteStringCoder :: Type -> Flow (Graph Kv) (Coder (Graph Kv) (Graph Kv) (Term) BS.ByteString)
...
jsonStringCoder :: Type -> Flow (Graph Kv) (Coder (Graph Kv) (Graph Kv) (Term) String)
