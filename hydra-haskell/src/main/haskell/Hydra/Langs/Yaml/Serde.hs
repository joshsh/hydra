...
yamlByteStringCoder :: Type -> Flow (Graph Kv) (Coder (Graph Kv) (Graph Kv) (Term) BS.ByteString)
...
yamlStringCoder :: Type -> Flow (Graph Kv) (Coder (Graph Kv) (Graph Kv) (Term) String)
